...
Movement_6Cylinder::Movement_6Cylinder(void)
{	
...
void Movement_6Cylinder::MOVE(RoadMap world, double &m_dXpos, double &m_dYpos, double &m_dStartDir, double m_dAcc)
{	
...
double Movement_6Cylinder::setNextTurn(Intersection* itr, double m_dStartDir)
{
	string north = "";
	string east = "";
	string south = "";
...
void Movement_6Cylinder::speed_algorithm(Intersection* itr, int TLstat, double TSDSL, double AB, double SLmps, double &TSDVS, double m_dAcc)
{
