...
Movement_4Cylinder::Movement_4Cylinder(void)
{
...
void Movement_4Cylinder::MOVE(RoadMap world, double &m_dXpos, double &m_dYpos, double &m_dStartDir, double m_dAcc)
{	
...
double Movement_4Cylinder::setNextTurn(Intersection* itr, double m_dStartDir)
{
	string north = "";
	string east = "";
	string south = "";
...
void Movement_4Cylinder::speed_algorithm(Intersection* itr, int TLstat, double TSDSL, double AB, double SLmps, double &TSDVS, double m_dAcc)
{
