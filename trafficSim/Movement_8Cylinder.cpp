...
Movement_8Cylinder::Movement_8Cylinder(void)
{
...
void Movement_8Cylinder::MOVE(RoadMap world, double &m_dXpos, double &m_dYpos, double &m_dStartDir, double m_dAcc)
{	
...
double Movement_8Cylinder::setNextTurn(Intersection* itr, double m_dStartDir)
{
	string north = "";
	string east = "";
	string south = "";
...
void Movement_8Cylinder::speed_algorithm(Intersection* itr, int TLstat, double TSDSL, double AB, double SLmps, double &TSDVS, double m_dAcc)
{
