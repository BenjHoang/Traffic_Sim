...
Movement_18Wheeler::Movement_18Wheeler(void)
{
...
void Movement_18Wheeler::MOVE(RoadMap world, double &m_dXpos, double &m_dYpos, double &m_dStartDir, double m_dAcc)
{	
...
double Movement_18Wheeler::setNextTurn(Intersection* itr, double m_dStartDir)
{
	string north = "";
	string east = "";
	string south = "";
...
void Movement_18Wheeler::speed_algorithm(Intersection* itr, int TLstat, double TSDSL, double AB, double SLmps, double &TSDVS, double m_dAcc)
{
